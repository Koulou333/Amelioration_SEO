<?php	
	...
	$to = 'mohamedsimintou@gmail.com'; // Email submissions are sent to this email

	// Create email	
	$email_subject = "Message depuis votre site web";
	$email_body = "Tu as reçu un message. \n\n".
				  "Name: $name \nEmail: $email \nInput_504: $input_504 \nMessage: $message \n";
	$headers = "MIME-Version: 1.0\r\nContent-type: text/plain; charset=UTF-8\r\n";	
	$headers .= "From: mohamedsimintou@gmail.com\n";
